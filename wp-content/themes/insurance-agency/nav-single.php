<!-- primary navigation for single page -->	
  <div id="home"></div> 
  <header>
  <div class="wrapper100percent <?php if ( is_page_template('page-templates/page-front-page.php')) echo "navbar-fixed-top"; else ""; ?>">    
  <div class="top1 top">  
  ...
  <!-- menu -->
    <nav class="navbar navbar-height1 <?php if ( is_page_template('page-templates/page-front-page.php') or is_page_template('page-templates/page-front-page2.php')) echo "menuswitch-js"; else ""; ?>"> 

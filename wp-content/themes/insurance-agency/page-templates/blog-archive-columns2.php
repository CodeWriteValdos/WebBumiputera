...
/*Template Name: Blog archive posts - 2 columns
*/
get_header(); ?>
    ...
    <div class="container">
      <div class="row">
        <div class="<?php echo rt_insurance_agency_archivesidebar1() ?>"> 
		    <div class="row">
		    <div class="masonry-grid1">
          <?php 
		      $args = array( 'post_type' => 'post' ); $loop = new WP_Query( $args ); 
		      while ( $loop->have_posts() ) : $loop->the_post();
          ?>
		      <div class="col-md-6 blogpages masonry-grid-item"> 
          <article class="blogpost">
            <div class="text-center">
              <?php the_post_thumbnail('rt_insurance_two_rows_img'); ?>
            </div> 
            <div class="wrapper100percent">
              <div <?php post_class(); ?>>

...
<div class="fw-col-lg-12">  
  ...
  <?php 
	  $terms = get_terms("rt-ins-galleryfilter-categories"); 
	  $count = count($terms); 
	  if ( $count > 0 ){ 
...
<div id="isotopecontainer" class="fw-row" >
 
<?php
$args = array( 'post_type' => 'rt-ins-galleryfilter', 'posts_per_page' => $limit, 'order' => $order, 'columns' => $columns );
$loop = new WP_Query( $args );
while ( $loop->have_posts() ) : $loop->the_post();

$post = NULL;
$terms = get_the_terms( $post, 'rt-ins-galleryfilter-categories' );						

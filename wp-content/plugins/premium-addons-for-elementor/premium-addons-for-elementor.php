    ...
    public function get_premium_pro_notice() {
        ...
        if ( ! is_plugin_installed( $pro_path ) && current_user_can( 'install_plugins' ) ) {
            ...
            if ( '1' === $get_pro && '1' === $get_pro_sale ) {
                ...
                $message = sprintf( __('<p style="display: flex; align-items: center; padding:10px 10px 10px 0;"><img src="%s" style="margin-right: 0.8em; width: 40px;">10 Early Bird Sale on&nbsp<strong>Premium Addons PRO.&nbsp</strong><span> Don’t Miss It&nbsp</span><a href="%s" target="_blank" style="flex-grow: 2;"> Click Here To Get It.</a>', 'premium-addons-for-elementor' ), PREMIUM_ADDONS_URL .'admin/images/premium-addons-logo.png'  ,$url );

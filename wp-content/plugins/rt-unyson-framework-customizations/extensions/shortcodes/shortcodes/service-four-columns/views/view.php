...
<div class="services">
  <div class="one-service one-service-column3 <?php echo $atts['color']?>">
    <ul>
      <li>
  ...
  <div class="one-service one-service-column3 <?php echo $atts['color2']?>">
    <ul>
      <li>
  ...
  <div class="one-service one-service-column3 <?php echo $atts['color3']?>">
    <ul>
      <li>
  ...
  <div class="one-service one-service-column3 <?php echo $atts['color4']?>">
    <ul>
      <li>
